...
![](images/lower_sensitive_dose_formats.svg){width="220"}
...
Most of these are pages, but you'll see th" has an arrow `>`; it is a folder with additional pages inside.
...
**Have a look at the filenames.** We can recognize the names of the webpages we've seen above, and they have red arrows marking them in the image below.
