...
**Combocat is a method for scalable drug combination screening** which uses acoustic liquid handler protocols and custom drug template designs for fast, efficient screening. Everything has been designed to work in an end-to-end fashion. This means a researcher can test 1, hundreds, or even thousands of drug combinations.

![](images/experiment_scale.svg)
